...
const authorityPage = {
  "assertions": [
    {
      "claim_id": "CLM-CLAIM-DCK-C-010",
      "rendered_component": "approved-requirements",
      "visible_text": "Pharaoh pass: 2x pyramids + instafill (official); observed 120 Robux (140 base struck through)."
    },
    {
      "claim_id": "CLM-CLAIM-PH-COMPLETION-CHECK-001",
      "rendered_component": "completion-check",
      "visible_text": "You decided right when you reviewed effects, price, and your play frequency - and know the pass is optional."
    },
    {
      "claim_id": "CLM-CLAIM-PH-NEXT-001",
      "rendered_component": "next-step",
      "visible_text": "Next: see what doubled pyramids unlock and check the codes status before spending."
    },
    {
      "claim_id": "CLM-CLAIM-PH-PROC-001",
      "rendered_component": "ordered-action-steps",
      "visible_text": "Compare the observed 120 Robux price with your play frequency."
    },
    {
      "claim_id": "CLM-CLAIM-PH-RECOVERY-001",
      "rendered_component": "recovery-guidance",
      "visible_text": "If the price differs in game, prices changed - the checked date tells you what we observed."
    },
    {
      "claim_id": "CLM-CLAIM-PH-START-001",
      "rendered_component": "verified-start-state",
      "visible_text": "You are weighing the Pharaoh pass against the free progression path."
    },
    {
      "claim_id": "CLM-CLAIM-PH-STEP-001",
      "rendered_component": "ordered-action-steps",
      "visible_text": "Check the official effects: 2x pyramids and instafill."
    },
    {
      "claim_id": "CLM-CLAIM-PH-STEP-002",
      "rendered_component": "ordered-action-steps",
      "visible_text": "Compare the observed 120 Robux price with your play frequency."
    },
    {
      "claim_id": "CLM-CLAIM-PH-STEP-003",
      "rendered_component": "ordered-action-steps",
      "visible_text": "Decide by play frequency: daily players benefit most."
    },
    {
      "claim_id": "CLM-CLAIM-PH-STEP-004",
      "rendered_component": "ordered-action-steps",
      "visible_text": "Track your pyramid pace before deciding on the pass."
    },
    {
      "claim_id": "CLM-CLAIM-PH-SUCCESS-001",
      "rendered_component": "verified-success-state",
      "visible_text": "You are finished when you can justify your buy-or-skip choice."
    },
    {
      "claim_id": "CLM-CLAIM-PH-VERSION-001",
      "rendered_component": "version-boundary",
      "visible_text": "The 120 Robux price was observed in September 2026; prices can change."
    },
    {
      "claim_id": "CLM-CLAIM-PHARAOH-CONTEXT-001",
      "rendered_component": "location-cue",
      "visible_text": "The Pharaoh pass's instafill was demonstrated adding 50,000+ blocks to the shared pyramid at once in September 2026 gameplay footage."
    }
  ],
  "contentBlocks": [
    {
      "classification": "requirement",
      "publicText": "Pharaoh pass: 2x pyramids + instafill (official); observed 120 Robux (140 base struck through)."
    },
    {
      "classification": "completion check",
      "publicText": "You decided right when you reviewed effects, price, and your play frequency - and know the pass is optional."
    },
    {
      "classification": "next step",
      "publicText": "Next: see what doubled pyramids unlock and check the codes status before spending."
    },
    {
      "classification": "action step",
      "publicText": "Compare the observed 120 Robux price with your play frequency."
    },
    {
      "classification": "recovery guidance",
      "publicText": "If the price differs in game, prices changed - the checked date tells you what we observed."
    },
    {
      "classification": "requirement",
      "publicText": "You are weighing the Pharaoh pass against the free progression path."
    },
    {
      "classification": "action step",
      "publicText": "Check the official effects: 2x pyramids and instafill."
    },
    {
      "classification": "action step",
      "publicText": "Compare the observed 120 Robux price with your play frequency."
    ...
    {
      "classification": "action step",
      "publicText": "Decide by play frequency: daily players benefit most."
    },
    {
      "classification": "action step",
      "publicText": "Track your pyramid pace before deciding on the pass."
    },
    {
      "classification": "completion check",
      "publicText": "You are finished when you can justify your buy-or-skip choice."
    },
    {
      "classification": "version boundary",
      "publicText": "The 120 Robux price was observed in September 2026; prices can change."
    },
    {
      "classification": "player answer",
      "publicText": "The Pharaoh pass's instafill was demonstrated adding 50,000+ blocks to the shared pyramid at once in September 2026 gameplay footage."
    },
    {
    ...
    {
      "classification": "source note",
      "publicText": "Verified source. Last checked 2026-09-18."
    },
    {
      "classification": "source note",
  ...
  "playerTask": "Progression guide: decide whether to buy the Pharaoh pass with full information: effects, observed price, honest framing",
  "publicSummary": "You are finished when you can justify your buy-or-skip choice.",
  "route": "/pharaoh",
  "successState": "You are finished when you can justify your buy-or-skip choice.",
  "title": "Progression guide: decide whether to buy the Pharaoh pass with full information: effects, observed price, honest framing"
};
...
export const metadata: Metadata = {
  title: "Progression guide: decide whether to buy the Pharaoh pass with full information: effects, observed price, honest framing",
  description: "You are finished when you can justify your buy-or-skip choice.",
